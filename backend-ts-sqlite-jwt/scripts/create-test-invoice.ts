...
async function createTestInvoice() {
  try {
    ...
    console.log(`   DELETE FROM DetalleVenta WHERE ventaId = ${venta.id};`);
    console.log(`   DELETE FROM Venta WHERE id = ${venta.id};`);
    console.log(`\n   O usa el script: npm run delete-test-invoice ${venta.id}`);
